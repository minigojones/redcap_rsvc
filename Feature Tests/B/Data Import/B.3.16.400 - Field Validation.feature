Feature: User Interface: The system shall import only valid formats for text fields with validation.
    ...
    Scenario: B.3.16.400.100 Import valid formats for text fields
        ...
        And I upload a "csv" format file located at "import_files//B.3.16.400_DataImport_Rows.csv", by clicking the button near "Upload your CSV file:" to browse for the file, and clicking the button labeled "Upload File" to upload the file
